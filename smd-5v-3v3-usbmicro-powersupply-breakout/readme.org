...
- Very stable output with the worst ripple being approx 17mV
- Given the mean of the signal is 3.294V a 17mV ripple is well within spec for the min/max Vout for a 5V signal on the datasheet
